...
class sfTemplateEngine {
	 ...
	 * Constructor.
	 *
	 * @param sfTemplateLoaderInterface $loader
	 *        	A loader instance
	 * @param array $renderers
	 *        	An array of renderer instances
	 * @param sfTemplateHelperSet $helperSet
	 ...
	 *        
	 * @throws InvalidArgumentException if the renderer does not exist or if the
	 ...
	 * @param string $name
	 *        	The helper name
	 * @param sfTemplateHelperInterface $value
	 *        	The helper value
	 */
	 ...
	 *        	The slot name
	 *        	
	 * @throws InvalidArgumentException if a slot with the same name is already
	 *         started
	 */
	 ...
	 *        	The default slot content
	 *        	
	 * @return Boolean true if the slot is defined or if a default content has
	 *         been provided, false otherwise
	 */
