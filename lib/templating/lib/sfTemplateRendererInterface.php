...
/**
 * sfTemplateRendererInterface is the interface all renderer classes must
 * implement.
 *
 * @package symfony
...
interface sfTemplateRendererInterface {
	 ...
	 *
	 * @param sfTemplateStorage $template
	 *        	The template to render
	 * @param array $parameters
	 *        	An array of parameters to pass to the template
	 *        	
	 * @return string false evaluated template, or false if the renderer is
