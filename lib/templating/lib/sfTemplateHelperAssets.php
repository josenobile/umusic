 ...
 * <code>
 *   <img src="<?php/**
 * sfTemplateHelperAssets is the base class for all helper classes that manages
 * assets.
 *
 * Usage:
 *
...
class sfTemplateHelperAssets extends sfTemplateHelper {
	 ...
	 *        	A public path
	 *        	
	 * @return string A public path which takes into account the base path and
	 *         URL path
	 */
