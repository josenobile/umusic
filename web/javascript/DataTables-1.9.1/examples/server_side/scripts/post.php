...
/*
 * Filtering NOTE this does not match the built-in DataTables filtering which
 * does it word by word on any field. It's possible to do here, but concerned
...
while ( $aRow = mysql_fetch_array ( $rResult ) ) {
	...
	/*
	 * Optional Configuration: If you need to add any extra columns
	 * (add/edit/delete etc) to the table, that aren't in the database - you can
	 * do it here
	 */
