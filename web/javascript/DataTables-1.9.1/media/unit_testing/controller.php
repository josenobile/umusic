...
<script type="text/javascript" charset="utf-8">
			...
			/*
			 * Get the tests dynamically from the 'tests' directory, and their
			 * templates
			 */
			$aFiles = array ();
			...
			for($i = 0; $i < count ( $aFiles ); $i ++) {
				...
				echo '{ ' . '"sTemplate": "' . $sTemplate . '", ' . '"sTest": "' . $aFiles [$i] . '", ' . '"sGroup": "' . $aPath [1] . '"},' . "\n";
			}
...
<body id="controller">
	...
	<div id="test_running">
		Running test: <span id="test_number"></span>
	</div>
	<div id="test_info">
