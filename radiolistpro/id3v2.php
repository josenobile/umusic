...
var $LookFrameLen=array();	//	"	"
	...
	if(intval($this->mpegInfo['BitrateDec'])<1){
	echo "NO se pudo obtener la duracion de ".$this->TargetNamFile." por que no se pudo obtener la velocidad de reproduccion (Ej 128kb/s)";
	$this->mpegInfo['PlaySeconds'] = 0;
	}else{
